...
LEDBlink.obj: ../LEDBlink.cpp $(GEN_OPTS) $(GEN_HDRS)
	...
	"/opt/ti/ccsv6/tools/compiler/ti-cgt-arm_5.2.2/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me -O2 --include_path="/opt/ti/ccsv6/tools/compiler/ti-cgt-arm_5.2.2/include" --include_path="/home/akbkuku/Desktop/TimingTesting" --gcc --define=ccs="ccs" --define=PART_TM4C123GH6PM --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="LEDBlink.pp" $(GEN_OPTS__FLAG) "$(shell echo $<)"
